...
function ParquetPage({ data, filename, isLoading, onBack }) {
  ...
  const columnTooltips = {
    ...
    'FX_clr_Bars': 'Forward consecutive same-color bars',
    'FX_clr_price': 'Forward price move during same-color run',
    'FX_clr_ADR': 'Forward same-color move normalized by ADR',
    'FX_clr_RR': 'Forward same-color move normalized by reversal size',
    'FX_MA1_Price': 'Forward price move to bar closing beyond MA1',
    'FX_MA1_ADR': 'Forward MA1 move normalized by ADR',
    'FX_MA1_RR': 'Forward MA1 move normalized by reversal size',
    'FX_MA2_Price': 'Forward price move to bar closing beyond MA2',
    'FX_MA2_ADR': 'Forward MA2 move normalized by ADR',
    'FX_MA2_RR': 'Forward MA2 move normalized by reversal size',
    'FX_MA3_Price': 'Forward price move to bar closing beyond MA3',
    'FX_MA3_ADR': 'Forward MA3 move normalized by ADR',
    'FX_MA3_RR': 'Forward MA3 move normalized by reversal size',
  }
